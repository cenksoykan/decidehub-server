        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserImageGoogleUrl = table.Column<string>(nullable: true),
                    TenantId = table.Column<string>(nullable: true),
                    IsDeleted = table.Column<bool>(nullable: false),
                    CreatedAt = table.Column<DateTime>(nullable: true, defaultValueSql: "now() at time zone 'utc'"),
                    GeneratePassToken = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(nullable: true),
                    OptionsJsonString = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(nullable: false),
                    AuthorityPercent = table.Column<decimal>(nullable: false),
                    InitialAuthorityPercent = table.Column<decimal>(nullable: false),
                    TenantId = table.Column<string>(nullable: true),
                    LanguagePreference = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(nullable: false),
                    UserImageStr = table.Column<string>(nullable: true),
                    UserImageSmallStr = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SettingJsonString = table.Column<string>(nullable: true),
                    TenantId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PollSetting", x => x.PollId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VotedUserId = table.Column<string>(nullable: true),
                    VoterId = table.Column<string>(nullable: true),
                    VotedAt = table.Column<DateTime>(nullable: false),
                    TenantId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
